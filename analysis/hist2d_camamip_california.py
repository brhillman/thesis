...
varinfo = numpy.array([
        ["clMISR" ,"misr"                  ,"MISR" ],
        ["clMISR" ,"cam4_1deg_release_amip","CAM4" ],
        ["clMISR" ,"cam5_1deg_release_amip","CAM5" ],
        ["clisccp","isccp"                 ,"ISCCP"],
        ["clisccp","cam4_1deg_release_amip","CAM4" ],
        ["clisccp","cam5_1deg_release_amip","CAM5" ],
        ["clmodis","modis"                 ,"MODIS"],
        ["clmodis","cam4_1deg_release_amip","CAM4" ],
        ["clmodis","cam5_1deg_release_amip","CAM5" ],
    ])
varnames = varinfo[:,0]
casenames = varinfo[:,1]
...
# save figure
figure.savefig("../graphics/hist2d_camamip_california.pdf",format="pdf")
